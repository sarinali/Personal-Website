...
function Home() {
   ...
   <div className="home-description-intro">I am a 
   <b className="bold-description"> student-learning-to-be-developer</b> with an interest in <b className="bold-description">creating</b>, <b className="bold-description">learning</b> and <b className="bold-description">building</b>! Creating: experiences and technology, Learning: anything and everything I can get my hands on, Building: technology and life experiences!</div>
            </div>
